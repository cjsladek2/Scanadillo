  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content:
        "Hi! I'm your ingredient analysis assistant. Ask me anything about the ingredients in your scanned label!",
    },
  ]);
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const errorMessage = {
        role: "assistant",
        content:
          "Could not connect to the chat server. Make sure the API is running.",
      };
      setMessages((prev) => [...prev, errorMessage]);
    } finally {
      setLoading(false);
    ...
    <div className="glass p-6 rounded-3xl shadow-xl max-w-5xl mx-auto">
      ...
      <div className="mb-6 border-b border-gray-200 dark:border-gray-800 pb-4">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
          Curious about ingredients, additives, or what’s hiding on a label? Ask
          away.
        </p>
      </div>
      ...
      <div className="h-96 overflow-y-auto mb-4 space-y-4 p-4 bg-gray-50 dark:bg-gray-900 rounded-xl">
        {messages.map((message, index) => (
          ...
          >
            ...
            >
              <div className="text-sm prose prose-indigo dark:prose-invert max-w-none">
                <ReactMarkdown
      ...
      <div className="flex space-x-2">
        ...
        <button
          onClick={sendMessage}
          className="px-6 py-3 bg-gradient-to-r from-indigo-500 to-green-400 text-white rounded-full font-semibold transition-all hover:shadow-md"
        >
          Send
        </button>
      </div>
          ...
          <div className="flex flex-wrap gap-2">
            {[
              ...
              <button
                ...
                className="text-xs px-3 py-1.5 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-full hover:shadow-sm transition-all"
              >
                {suggestion}
              </button>
            ))}
